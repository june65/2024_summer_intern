...
parser.add_argument('--min_ped', type=int, default=1)
...
train_dataset = Dataload(datasets_path + 'train/',  obs_len=args.obs_seq_len, pred_len=args.pred_seq_len, skip=args.skip, threshold=args.threshold, min_ped=args.min_ped)
